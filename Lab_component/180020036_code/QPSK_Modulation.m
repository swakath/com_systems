% This function performs QPSK modulation (without gray labelling) on the 
% given signal and adds a Additive White Gaussian Noise corresponding to 
% the given snr value. The function finally returns the modulated signal.
function [modulatedSignal] = QPSK_Modulation(signal,snr)
